...
export default function DisplayPage() {
  ...
  if (isLoading) {
    return (
      <main className="flex min-h-screen items-center justify-center bg-slate-950 px-6 py-10 text-white">
        <div className="w-full max-w-5xl rounded-[36px] border border-white/12 bg-white/8 px-6 py-6 shadow-[0_24px_80px_rgba(0,0,0,0.26)] backdrop-blur-md sm:px-8 sm:py-8">
